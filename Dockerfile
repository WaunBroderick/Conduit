...
ENV MONGO_ATLAS_USER=${{secrets.MONGO_ATLAS_USER}}
ENV MONGO_ATLAS_PASSWORD=${{secrets.MONGO_ATLAS_PASSWORD}}
ENV MONGO_ATLAS_DB_ADDRESS=${{secrets.MONGO_ATLAS_DB_ADDRESS}}
ENV MONGO_ATLAS_DB=${{secrets.MONGO_ATLAS_DB}}
